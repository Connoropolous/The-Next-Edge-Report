      ...
      <div class="row demo-row">
        <div class="span3">
          <a href="#fakelink" class="btn btn-large btn-block disabled newposts">New Posts</a>
        </div>
        <div class="span3">
          <a href="/people.php" class="btn btn-large btn-block btn-info">Explore People & Posts</a>
        </div>
        <div class="span3">
